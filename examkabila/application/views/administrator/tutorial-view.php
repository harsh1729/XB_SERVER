...
<div class="container-fluid" style="min-height:89vh;">
	<form id="tutorial_submit_form" action="<?=base_url()?>admin_request/tutorial/submit_tutorial">
		<div class="row">
			<div class="col-sm-9">
				Enter the name:-<div class="lang_class form-control" required contenteditable="true" id="tutorial_name" style="overflow:auto;height:50px;margin-bottom:50px;">
					
				</div>
				Enter the text<div class="lang_class form-control" required contenteditable="true" id="tutorial_text" style="overflow:auto;height:100px;" >
				 
				</div>
			</div>
			<div class="col-sm-3">
				Enter image:-<div id="tutorialdropzone" class="dropzone text-center "  action="<?=base_url()?>admin_request/tutorial/upload_image" style="height:210px; background-color:#aaaaaa;border:1px solid #666666;border-radius:10px;"></div>
			             <input type="hidden" id="tutorial_link" value="" name="tutorial_link">
			</div> 	
		</div>
