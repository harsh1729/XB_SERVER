...
<div class="container-fluid" style="min-height:89vh;">
	<form id="blog_submit_form" action="<?=base_url()?>admin_request/blog/submit_blog">
	<div class="row">
		<div class="col-sm-9">
			<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					Enter Name:- <div class="lang_class form-control" contenteditable="true" id="blog_name" style="height:40px;overflow:auto;">
			...
			<div class="row" style="margin-top:20px;">
				<div class="col-sm-12 " >
					Enter text:-<div class="lang_class form-control" contenteditable="true" id="blog_text" style="height:140px;overflow:auto;">
		...
		<div class="col-sm-3">
			<div class="row">
				<div class="col-sm-12">
					<select class="form-control" style="margin-bottom:10px;" id="blog_selection">
			...
			<div class="row">
				<div class="col-sm-12">
					<div id="blogdropzone" class="dropzone text-center "  action="<?=base_url()?>admin_request/blog/upload_image" style="height:210px; background-color:#aaaaaa;border:1px solid #666666;border-radius:10px;"></div>
		         	<input type="hidden" id="blog_link" name="blog_link">	
				</div>
